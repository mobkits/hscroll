...
Hscroll.prototype.bind = function(){
  ...
  if (!hasTouch) {
    ...
    this._wheelHandler = wheel(this.el, this.onwheel.bind(this), true)
  } else {
    // W3C touch events
  ...
  this._refresh = debounce(this.refresh.bind(this), 100)
  event.bind(window, 'orientationchange', this._refresh)
  event.bind(window, 'resize', this._refresh)
}
...
Hscroll.prototype.unbind = function(){
  ...
  event.unbind(window, 'resize', this._refresh)
